...
#define _FXM_PLATFORM_ANDROID_ 5


#ifndef _FX_OS_
#if defined(__OHOS__)
#define _FX_OS_ _FX_OPENHARMONY_
#define _FXM_PLATFORM_ _FXM_PLATFORM_OPENHARMONY_
