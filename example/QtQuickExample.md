...
本文档描述了如何使用Qt Quick示例，Qt的所有示例工程都放在SDK中example目录中，以下目录列出了QML及Qt Quick、Qt Quick Control相关的示例工程。

![image-20221223171802441](images/image-20221223171802441.png)

chart目录存放了统计图表相关的QML示例存，Qt QUick的工程编译使用同[CreatorQtApp.md](.\CreatorQtApp.md)描述一致。

# 编译工程

我们以examples\charts\qmlchart工程为例，使用配置了OpenHarmony构建环境的QtCreator打开该工程然后进行编译，编译构建即可，编译完成后会生成libqmlchart.so文件。
...
![image-20221225170959800](images/image-20221225170959800.png)
...
<font color="red">**注：QML工程中用到的QML文件及导入的第三方JavaScript文件需要添加到ETS工程中的资源文件中，资源文件的添加参考CreateQtApp.md文件中描述的资源文件添加章节**</font>
